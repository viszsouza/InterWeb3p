...
//Inserindo dados no Banco
    ...
    if (isset($nome) && isset($cnpj) && isset($contato) && isset($endereco) && isset($email) && isset($bairro) && isset($n_endereco) && isset($complemento) && isset($senha) && isset($funcao))  {
        ...
        $insere = "INSERT INTO cadastro (contato, nome, cnpj, email, senha, n_endereco, bairro, complemento, senha_confirm, funcao) VALUES ('$contato','$nome','$cnpj','$email','$senha_crip','$n_endereco','$bairro','$complemento','$senha','$funcao')";
